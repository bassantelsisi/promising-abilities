            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                  <a href="/opportunities" className="bg-teal-600 hover:bg-teal-700 text-white font-medium px-6 py-3 rounded-lg text-center">
                    Find Opportunities
                  </a>
                  <a href="/support" className="bg-white hover:bg-gray-100 text-teal-600 border border-teal-600 font-medium px-6 py-3 rounded-lg text-center">
                    Get Support
                  </a>
                </div>
              </div>
